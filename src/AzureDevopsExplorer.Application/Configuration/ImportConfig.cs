...
public class ImportConfig
{
    ...
    public bool BuildRunRuntimeExpandedYamlAnalysis { get; set; } = false;
    public bool BuildRunYamlAnalysisKeepFileContents { get; set; } = false;
    ...
    public bool ProjectsImport { get; set; } = false;
    ...
    public bool PipelineImport { get; set; } = false;
    public bool PipelineConfigurationYamlTemplateImport { get; set; } = false;
